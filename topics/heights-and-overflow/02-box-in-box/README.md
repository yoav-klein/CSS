# Heights and overflows - box in box
---
...
3.a - setting `overflow: auto` on outer will make outer the scrolling container, setting `overflow:auto` on inner will do nothing, since there's no overflow in inner.
